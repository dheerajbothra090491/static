                  ...
                  <ul id="menu-primary-menu" class="menu">
                    <li class="menu-item menu-item-has-children ">
                          ...
                          <div class="menu-bar">
                            ...
                            <ul class="sub-menu-bar">
                              ...
                              <li class="menu-item">
                                <a href="home-09.html">Jobs in Hyderabad </a>
                              </li>
                              <li class="menu-item">
                                <a href="home-10.html">Jobs in Chennai</a>
                              </li>
                              <li class="menu-item">
                                <a href="home-10.html">Jobs in Pune</a>
                              </li>
                            </ul>
                            <ul class="sub-menu-bar">
                              <li >
                              ...
                              <li class="menu-item">
                                <a href="home-09.html">Jobs by Designation </a>
                              </li>
                              <li class="menu-item">
                                <a href="home-10.html">Jobs by Location</a>
                              </li>
                              <li class="menu-item">
                                <a href="home-10.html">Create free job alert</a>
                              </li>
                            </ul>
                          </div>
                        </li>
                        <li class="menu-item menu-item-has-children">
                          ...
                          <div class="menu-bar">
                            ...
                            <ul class="sub-menu-bar">
                              ...
                              <li class="menu-item">
                                <a href="home-09.html">Featured Companies </a>
                              </li>
                              <li class="menu-item">
                                <a href="home-10.html">IT Companies</a>
                              </li>
                              <li class="menu-item">
                                <a href="home-10.html">Startup Companies</a>
                              </li>
                            </ul>
                            <ul class="sub-menu-bar">
                              <li >
                              ...
                              <li class="menu-item">
                                <a href="home-09.html">Delhi </a>
                              </li>
                              <li class="menu-item">
                                <a href="home-10.html">Hyderabad</a>
                              </li>
                              <li class="menu-item">
                                <a href="home-10.html">View All</a>
                              </li>
                            </ul>
                          </div>
                    ...
                    <li class="menu-item menu-item-has-children">
                      ...
                      <ul class="sub-menu st1">
                        <li class="nav-sub">
                          <a href="#">Jobseeker Services <span class="icon-keyboard_arrow_right"></span>  </a>
                          <ul class="nav-sub-menu">
                            
                              <li class="nav-menu-item">
                                <a href="#">Build Your CV for Free</a>
                              </li>
                              <li class="nav-menu-item">
							  ...
							  <li class="nav-menu-item">
                                ...
                                <li class="nav-menu-item">
                                  <a href="employers-topmap.html">Trend Updates</a>
                                </li>
						...
						<li class="nav-sub">
                          <a href="#">Employer Services <span class="icon-keyboard_arrow_right"></span>  </a>
                          <ul class="nav-sub-menu">
                                <li class="nav-menu-item">
                                  <a href="employers-list.html"></a>
                                </li>
                                <li class="nav-menu-item">
                                  <a href="employers_grid.html">Permanent Staffing</a>
                                </li>
                                <li class="nav-menu-item">
                                ...
                                <li class="nav-menu-item">
                                  <a href="employers-topmap.html">Recruitment Process Outsourcing</a>
                                </li>
  ...
  <section class="term-section">
    <div class="tf-container">
      <div class="row tf-tab">
        <div class="col-lg-4">
          <ul class="menu-tab tab-term po-sticky">
            <li class="ct-tab">1. Terms </li>
            <li class="ct-tab active">2. Limitations </li>
            <li class="ct-tab">3. Revisions and errata</li>
            <li class="ct-tab">4. Site terms of use modifications</li>
            <li class="ct-tab">5. Risks</li>
          </ul>
        </div>
        <div class="col-lg-8">
          <div class="content-tab">
            <div class="term-content">
              <h4>Terms of use</h4>
              <h6>1. Terms </h6>
              <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer sed euismod justo, sit amet efficitur
                dui. Aliquam sodales vestibulum velit, eget sollicitudin quam. Donec non aliquam eros. Etiam sit amet
                lectus vel justo dignissim condimentum.</p>
              <p>In malesuada neque quis libero laoreet posuere. In consequat vitae ligula quis rutrum. Morbi dolor
                orci, maximus a pulvinar sed, bibendum ac lacus. Suspendisse in consectetur lorem. Pellentesque habitant
                morbi tristique senectus et netus et malesuada fames ac turpis egestas. Aliquam elementum, est sed
                interdum cursus, felis ex pharetra nisi, ut elementum tortor urna eu nulla. Donec rhoncus in purus quis
                blandit.</p>
              <p class="mgb-32">Etiam eleifend metus at nunc ultricies facilisis. Morbi finibus tristique interdum.
                Nullam vel eleifend est, eu posuere risus. Vestibulum ligula ex, ullamcorper sit amet molestie</p>
              <h6>2. Limitations</h6>
              <p>Etiam eleifend metus at nunc ultricies facilisis. Morbi finibus tristique interdum. Nullam vel eleifend
                est, eu posuere risus. Vestibulum ligula ex, ullamcorper sit amet molestie a, finibus nec ex.</p>
              <ul class="list-dot">
                <li> Aliquam elementum, est sed interdum cursus, felis ex pharetra nisi, ut elementum tortor urna eu
                  nulla. Donec rhoncus in purus quis blandit.</li>
                <li> Etiam eleifend metus at nunc ultricies facilisis.</li>
                <li> Nullam vel eleifend est, eu posuere risus. Vestibulum ligula ex, ullamcorper sit amet molestie a,
                  finibus nec ex.</li>
              </ul>
              <p class="mgb-32">Etiam eleifend metus at nunc ultricies facilisis. Morbi finibus tristique interdum.
                Nullam vel eleifend est, eu posuere risus. Vestibulum ligula ex, ullamcorper sit amet molestie</p>
              ...
              <p class="mgb-32">Etiam eleifend metus at nunc ultricies facilisis. Morbi finibus tristique interdum.
                Nullam vel eleifend est, eu posuere risus. Vestibulum ligula ex, ullamcorper sit amet molestie a,
                finibus nec ex.</p>
              ...
              <p>In malesuada neque quis libero laoreet posuere. In consequat vitae ligula quis rutrum. Morbi dolor
                ...
                blandit.</p>
              <p>Etiam eleifend metus at nunc ultricies facilisis. Morbi finibus tristique interdum. Nullam vel eleifend
                est, eu posuere risus. Vestibulum ligula ex, ullamcorper sit amet molestie </p>
            </div>
            <div class="term-content">
              <h6>2. Limitations</h6>
              <p>Etiam eleifend metus at nunc ultricies facilisis. Morbi finibus tristique interdum. Nullam vel eleifend
